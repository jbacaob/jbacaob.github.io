...
$$DR = s_{ABD}-AB = \frac{DA+BD-AB}{2},\quad DR' = s_{BCD} - BC= \frac{CD+BD-BC}{2}$$

where $$s_{XYZ}$$ stands for the semiperimeter of $$\bigtriangleup XYZ$$. Pitot's theorem implies straightforwardly that $$\frac{DA+BD-AB}{2}=\frac{CD+BD-BC}{2}$$. Hence, $$DR=DR'$$, so $$R\equiv R'$$ and thus $$J,\ R$$,  and $$F$$ are collinear with $$JF\perp BD$$. $$\square$$
...
We're ready to conclude. By Claim 1, observe that $$PP'\parallel JF$$. Together with Claim 2, we find that:

$$\frac{PS}{SP'} = \frac{R'R}{RR''} = \frac{JR}{RF}$$

with $$S\equiv \overline{PP'}\cap\overline{BD}$$ and $$R''$$ the antipode of $$R$$ in the incircle of $$\bigtriangleup BCD$$. This result and Thales' theorem jointly imply that $$PJ$$ and $$P'F$$ meet each other at a point on $$BD$$, say $$E'$$. Let $$M$$ be the midpoint of the segment $$JF$$. Of course, Thales' theorem ensures that $$IM$$ passes through $$E'$$. Now, it is also known that the pole of $$BD$$ with respect to $$\omega$$ is $$Q\equiv \overline{AC}\cap \overline{PI}$$ and that $$A,C,E,Q$$ forms a harmonic bundle. Let $$M'\equiv \overline{JF}\cap \overline{IE}$$. Then:

$$-1=(A,C;E,Q) \overset{I}{=} (J,F;M',P)$$

which together with $$JF\parallel PP'$$ implies that $$M'$$ is the midpoint of segment $$JF$$, i.e., $$M\equiv M'$$. Hence $$E\equiv E'$$ and the required collinearity follows. $$\square$$
