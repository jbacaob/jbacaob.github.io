...
where $$s_{XYZ}$$ stands for the semiperimeter of $$\bigtriangleup XYZ$$. Pitot's theorem implies straightforwardly that $$\frac{AB+DA-BD}{2}=\frac{BC+CD-BD}{2}$$. Hence, $$DR=DR'$$, so $$R\equiv R'$$ and thus $$J,\ R$$,  and $$F$$ are collinear with $$JF\perp BD$$.
...
with $$S\equiv \overline{PP'}\cap\overline{BD}$$. The aforementioned result and Thales' theorem jointly imply that $$PJ$$, $$P'F$$ and $$BD$$ concur at $$E$$. The required collinearity follows. $$\square$$
